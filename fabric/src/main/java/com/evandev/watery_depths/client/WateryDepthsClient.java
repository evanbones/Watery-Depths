...
public class WateryDepthsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        EntityModelLayerRegistry.registerModelLayer(CatfishRenderer.CATFISH_LAYER, CatfishModel::createBodyLayer);

        EntityRendererRegistry.register(ModEntities.CYPRESS_BOAT.get(), context ->
                new BoatRenderer(context, false, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/entity/boat/cypress.png"))
        );

        EntityRendererRegistry.register(ModEntities.CYPRESS_CHEST_BOAT.get(), context ->
                new BoatRenderer(context, true, ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "textures/entity/chest_boat/cypress.png"))
        );
