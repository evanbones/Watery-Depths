...
public class ClothConfigIntegration {
    ...
    public static Screen createScreen(Screen parent) {
        ...
        general.addEntry(entryBuilder.startBooleanToggle(Component.translatable("config.watery_depths.option.enabled"), config.enabled)
                .setDefaultValue(true)
                .setTooltip(Component.translatable("config.watery_depths.option.enabled.tooltip"))
        ...
        general.addEntry(entryBuilder.startStrList(Component.translatable("config.watery_depths.option.missing_id_map"), currentMapAsList)
                .setDefaultValue(new ArrayList<>())
                .setTooltip(Component.translatable("config.watery_depths.option.missing_id_map.tooltip"))
